      ...
      <BrowserRouter>
        <Routes>
          <Route path={ROUTES.ROOT} element={<Menu />}>
            ...
            <Route
              path={`${ROUTES.GENEROS}/editar/:id`}
              element={<EditarGenero />}
            />

            <Route path={ROUTES.ACTORES} element={<IndiceActores />} />
            <Route
              path={`${ROUTES.ACTORES}/crear`}
              element={<CrearActores />}
            />
            <Route
              path={`${ROUTES.ACTORES}/editar/:id`}
            ...
            <Route
              path={`${ROUTES.CINES}/editar/:id`}
              element={<EditarCines />}
            />

            <Route
              path={`${ROUTES.PELICULAS}/crear`}
              element={<CrearPelicula />}
            />
            <Route
              path={`${ROUTES.PELICULAS}/editar/:id`}
              element={<EditarPelicula />}
            />
            <Route
              path={`${ROUTES.PELICULAS}/filtrar_pelicula`}
              element={<FiltrarPelicula />}
            />
